...
const defaultEquations = [
  ...
  { infija: '2*(x+5)=12', postfija: '2x5+*12=', latex: '2*(x+5)=12' },
  ...
  { infija: '2*x+9=7', postfija: '2x*9+7=', latex: '2* x+9=7' },
  { infija: '10=3*x+4', postfija: '103x*4+=', latex: '10=3* x+4' },
  ...
  { infija: '7=-(2*x)+6', postfija: '72x*~6+=', latex: '7=-(2* x)+6' },
  ...
  { infija: '-(5*x)=30', postfija: '5x*~30=', latex: '-(5* x)=30' },
  { infija: 'sqrt(x+25)=10', postfija: 'x25+sqrt10=', latex: '\\sqrt{x+25}=10' },
  { infija: '5=12+x', postfija: '512x+=', latex: '5=12+x' },
  { infija: '((8*pot2(x)+3)/(5))=1', postfija: '8xpot2*3+5/1=', latex: '\\frac{8* x^2+3}{5}=1' },
  ...
  { infija: '-2*(x+5)=12', postfija: '2~x5+*12=', latex: '-2*(x+5)=12' },
  { infija: '-1=sqrt(1+sqrt(x))-2', postfija: '1~1xsqrt+sqrt2-=', latex: '-1=\\sqrt{1+\\sqrt{x}}-2' },
  { infija: '25*pot2(x)+8=9', postfija: '25xpot2*8+9=', latex: '25* x^2+8=9' },
...
async function seedFinalEquations() {
  ...
  try {
    ...
    for (let i = 0; i < defaultEquations.length; i++) {
      ...
      const solutionValues = solved.ok ? solved.solutions : [];
